...
public class TinyDB
{
    ...
    public ArrayList<Quote> getListObject(String key, Class<Quote> mClass)
    {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Quote> objects = new ArrayList<Quote>();

        for (String jObjString : objStrings)
        {
            Quote value = gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Quote> objArray)
    {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Quote obj : objArray)
        {
